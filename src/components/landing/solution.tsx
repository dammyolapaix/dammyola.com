    ...
    <section className="border-b border-border bg-background px-6 py-16 md:px-8 lg:px-12">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mt-6 text-muted-foreground">
          ...
          non-technical founders. We don&apos;t just write code—we help you
        ...
        <div className="mt-10 space-y-8">
          ...
          <div>
            <h3 className="font-semibold text-foreground">How we&apos;re different:</h3>
            <ul className="mt-3 list-disc space-y-2 pl-6 text-muted-foreground">
              <li>We explain everything in plain English</li>
              <li>We work in sprints so you see progress every week</li>
              <li>We use modern tech (Next.js) so your product is fast and easy to update</li>
